...
def test_power_positive():
    ...
    This test verifies that raising a positive number to a positive exponent returns the correct result.
    """
    # Arrange
    a = 10.0
    b = 5.0
...
def test_power_negative_exponent():
    ...
    This test verifies that raising a positive number to a negative exponent returns the correct result.
    """
    # Arrange
    a = 10.0
    b = -1.0
...
def test_modulus_positive():
    ...
    This test verifies that the modulus of two positive numbers returns the correct result.
    """
    # Arrange
    a = 10.0
    b = 3.0
...
def test_modulus_negative():
    """
    Test the modulus method with a negative divisor.
    
    This test verifies that the modulus of a positive number by a negative number returns the correct result.
    """
    # Arrange
    a = 10.0
    b = -3.0
...
def test_square_root_positive():
    """
    Test the square root method with a positive number.
    
    This test verifies that the square root of a positive number returns the correct result.
    """
    # Arrange
    a = 16.0
    expected_result = 4.0
...
def test_square_root_negative():
    """
    Test the square root method with a negative number.
    
    This test verifies that taking the square root of a negative number raises a ValueError.
    """
    # Arrange
    a = -1.0
    ...
    # Verify that the exception message is as expected
    assert str(exc_info.value) == "Square root of a negative number is not allowed."

def test_square_root_zero():
    """
    Test the square root method with zero.
