...
def test_factory_create_unsupported_calculation():
    ...
    a = 10.0
    b = 5.0
    unsupported_type = 'circumference'  # An unsupported calculation type
...
@patch.object(Operation, 'sqrt')
@patch.object(Operation, 'modulus')

def test_calculation_execute_parameterized(
    mock_modulus, mock_sqrt, mock_power, mock_division, mock_multiplication, mock_subtraction, mock_addition,
    ...
    if calc_type == 'add':
        ...
        mock_sqrt.return_value = expected_result
    ...
    if calc_type == 'add':
        ...
        mock_sqrt.assert_called_once_with(a)
    elif calc_type == 'modulus':
...
@pytest.mark.parametrize("calc_type, a, b, expected_str", [
    ...
    ('sqrt', 16.0, None, "SquareRootCalculation: 16.0 SquareRoot None = 4.0"),
...
@patch.object(Operation, 'sqrt', return_value=4.0)
