    ...
    **Why Static Methods?**
    ...
    def power(base: float, exponent: float) -> float:
        ...
        **Example:**
        ...
        8.0
        >>> Operation.power(5.0, 2.0)
        25.0
        >>> Operation.power(10.0, -1.0)
        0.1
    ...
    def sqrt(a: float) -> float:
        ...
        **Raises:**
        - `ValueError`: If `a` is negative, as square root of a negative number is not defined in the real number system.

        **Example:**
        >>> Operation.square_root(16.0)
        4.0
        >>> Operation.square_root(-1.0)
        Traceback (most recent call last):
            ... 
        ValueError: Square root of a negative number is not allowed.
        """
        if a < 0:
